  ...
  public class FielDepositarioController : Controller
  {
    ...
    public FileResult GerarRelatorio(int? id)
    {
      using (var doc = new PdfSharpCore.Pdf.PdfDocument())
      {
        ...
        List<FielDepositario> dados = new List<FielDepositario>();
        ...
        for (int i = 0; i < dados.Count; i++)
        {
          ...
          var texto =
            "                                 " + dados[i].Banco + ", já qualificado nos autos em epígrafe, " +
            "proposta em face de " + dados[i].Reu + ", também já qualificado, vem, por seus procuradores signatários, " +
            "respeitosamente, perante Vossa Excelência, INFORMAR os dados do fiel depositário do bem, " +
            "qual seja: " + dados[i].Fiel + ", RG: " + dados[i].RG + ", TEL: " + dados[i].Telefone + ", o qual acompanhará o Oficial de Justiça, no momento do " +
            "cumprimento do mandado e que o mesmo está autorizado a proceder com a remoção do bem apreendido para o pátio ou " +
            "depósito credenciado do autor.\n \n \n" +

            "                               Outrossim, requer que todas as intimações dos atos processuais destes autos sejam efetivadas na forma prevista nos " +
            "artigos 270 e 272 do Novo C.P.C.(Lei 13.105/2015), na pessoa de Cristiane Belinati Garcia Lopes, " + dados[i].Oab + ", independentemente " +
            "dos demais procuradores constantes nas procurações e substabelecimentos juntados a estes autos, sob pena de nulidade da " +
            "intimação, conforme previsto no artigo 280 do Novo C.P.C.\n \n \n" +
            "                                 Termos em que,\n" +
            "                                 Pede deferimento.\n" +
